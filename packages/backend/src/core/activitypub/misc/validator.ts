...
export function validateContentTypeSetAsActivityPub(response: Response): void {
	...
	if (contentType === '') throw new Error('Validate content type of AP response: No content-type header');
	if (
...
export function validateContentTypeSetAsJsonLD(response: Response): void {
	...
	if (contentType === '') throw new Error('Validate content type of JSON LD: No content-type header');
	if (
